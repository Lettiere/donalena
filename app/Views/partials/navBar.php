                ...
                <ul
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu border-0 p-3 rounded-0 shadow" aria-labelledby="pages">
                            <li><a href="index.html" class="dropdown-item">Sobre Nós</a></li>
                            <li><a href="index.html" class="dropdown-item">Loja</a></li>
                            <li><a href="index.html" class="dropdown-item">Produto Individual</a></li>
                            <li><a href="index.html" class="dropdown-item">Carrinho</a></li>
                            <li><a href="index.html" class="dropdown-item">Finalizar Compra</a></li>
                            <li><a href="index.html" class="dropdown-item">Blog</a></li>
                            <li><a href="index.html" class="dropdown-item">Post Individual</a></li>
                            <li><a href="index.html" class="dropdown-item">Estilos</a></li>
                            <li><a href="index.html" class="dropdown-item">Contato</a></li>
                            <li><a href="index.html" class="dropdown-item">Obrigado</a></li>
                            <li><a href="index.html" class="dropdown-item">Minha Conta</a></li>
                            <li><a href="index.html" class="dropdown-item">Erro 404</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
